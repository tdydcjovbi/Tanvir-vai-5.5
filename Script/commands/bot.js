...
"এত বট বট না করে আমার বস তানভীরের tiktok এর ভিডিও গুলো দেখতে পারো tik tok username :tanvir_hasan_6261 👈এটা সার্চ দিয়ে ভিডিও গুলো দেখো লাইক কমেন্ট কপি লিংক করে দিবা বুঝছো জানু😚",
...
   };
   if ((event.body.toLowerCase() == "@Mihi Islam") || (event.body.toLowerCase() == " ")) {
     return api.sendMessage("খবরদার কেউ এই আইডি মেনশন দিবানা এটা আমার বস তানভীর এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };
  if ((event.body.toLowerCase() == "Mihi") || (event.body.toLowerCase() == " ")) {
...
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস তানভীর এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  if ((event.body.toLowerCase() == "মিহি") || (event.body.toLowerCase() == " ")) {
...
  
   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
     return api.sendMessage("️ এই যে এভাবে তাকাবেন না এভাবে তাকালে আমার তানভীর বসের শরম করে 🫣🤭 ", threadID);
   };
